...
assert.match(html, /title="2026\/06\/08 17:00:00"[\s\S]*3小时前/, 'task table must render relative updated time with a localized absolute tooltip');
...
assert.match(html, /title="2026\/06\/08 16:00:00"[\s\S]*4小时前/, 'task detail panel must render relative created time with a localized absolute tooltip');
